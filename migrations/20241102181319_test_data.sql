...
INSERT INTO users (name, surname, country_code, email, password, phone_number, payment_gateway_customer_id, email_verified_at, document_verified_at) VALUES
('Manuel', 'Ceppi', 'IT', 'manuel.ceppi@test.com', '$2y$12$w5OR8VfTYgVFYsLbbTp/6ur1vLdWiTRcpV/xarG7z6YziSnzc7dfm', '1234567890', NULL, '2023-01-15 10:00:00', '2023-01-20 10:00:00'),
('Luigi', 'Bianchi', 'IT', 'luigi.bianchi@test.com', '$2y$12$w5OR8VfTYgVFYsLbbTp/6ur1vLdWiTRcpV/xarG7z6YziSnzc7dfm', '0987654321', 'cus_456DEF', '2023-02-10 10:00:00', NULL),
('Giulia', 'Verdi', 'IT', 'giulia.verdi@test.com', '$2y$12$w5OR8VfTYgVFYsLbbTp/6ur1vLdWiTRcpV/xarG7z6YziSnzc7dfm', '1122334455', 'cus_789GHI', '2023-03-05 12:00:00', '2023-03-10 12:00:00'),
('Marco', 'Neri', 'IT', 'marco.neri@test.com', '$2y$12$w5OR8VfTYgVFYsLbbTp/6ur1vLdWiTRcpV/xarG7z6YziSnzc7dfm', '5566778899', 'cus_012JKL', '2023-04-20 14:00:00', '2023-04-25 14:00:00');
