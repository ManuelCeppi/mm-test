...
INSERT INTO scooters (uid, name, primary_station_id, last_station_id, current_station_id, status, battery_level, license_plate) VALUES
('04A1B2C3D4E5F6', 'Scooter X1', 1, 1, 1, 'available', 100.00, 'AB123CD'),
('04B2C3D4E5F6A7', 'Scooter X2', 2, 2, 2, 'available', 100.00, 'CD456EF'),
('04C3D4E5F6A7B8', 'Scooter X3', 3, 3, 3, 'faulted', 45.20, 'EF789GH'),
('04D1E2F3A4B5C6', 'Scooter X4', 4, 1, 4, 'available', 100.00, 'GH012IJ'),
('04E2F3A4B5C6D7', 'Scooter X5', 5, 5, 5, 'available', 100.00, 'IJ345KL'),
('04F3A4B5C6D7E8', 'Scooter X6', 6, 6, NULL, 'unavailable', 52.75, 'KL678MN'),
('04A4B5C6D7E8F9', 'Scooter X7', 7, 7, 7, 'available', 100.00, 'MN901OP'),
('04B5C6D7E8F9A0', 'Scooter X8', 8, 8, 8, 'faulted', 20.50, 'OP234QR'),
('04C6D7E8F9A0B1', 'Scooter X9', 9, 9, 1, 'rented', 60.30, 'QR567ST'),
('04D7E8F9A0B1C2', 'Scooter X10', 10, 10, NULL, 'rented', 30.00, 'ST890UV'),
('04E8F9A0B1C2D3', 'Scooter X11', 11, 11, 11, 'available', 100.00, 'UV123WX'),
('04F9A0B1C2D3E4', 'Scooter X12', 12, 12, NULL, 'rented', 33.60, 'WX456YZ'),
('04A0B1C2D3E4F5', 'Scooter X13', 13, 13, 6, 'available', 100.00, 'YZ789AB'),
('04B1C2D3E4F5A6', 'Scooter X14', 14, 14, NULL, 'unavailable', 90.10, 'AD123GH'),
('04C2D3E4F5A6B7', 'Scooter X15', 15, 15, 8, 'rented', 58.90, 'GH456CD'),
('04D3E4F5A6B7C8', 'Scooter X16', 16, 16, 9, 'available', 100.00, 'CD789EF'),
('04E4F5A6B7C8D9', 'Scooter X17', 17, 17, 17, 'recharging', 25.30, 'EF012GH'),
('04F5A6B7C8D9E0', 'Scooter X18', 18, 18, 3, 'available', 100.00, 'GH345IJ'),
('04A6B7C8D9E0F1', 'Scooter X19', 19, 19, 4, 'unavailable', 40.40, 'IJ678KL'),
('04B7C8D9E0F1A2', 'Scooter X20', 20, 10, NULL, 'rented', 85.00, 'KL901MN');
...
(3, "test_stripe_payment_id_2");

UPDATE users SET default_payment_method_id = 1 where id = 1;
UPDATE users SET default_payment_method_id = 2 where id = 3;
